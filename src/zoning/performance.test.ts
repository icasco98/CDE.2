...
/*
 * The budget the brief set: one storey of a twenty by twenty-five plot, fourteen rooms, under
 * 150 ms, which is the pause between pressing Morph and the animation starting.
 */
...
it('partitions fourteen rooms on a 20 by 25 plot in under 150 ms', () => {
  ...
  expect([rooms.length, took < 150]).toEqual([14, true])
})
